...
public:
  ...
  MGARDX_EXEC void Operation1() {
    //printf( "this is Lpk1Reo3DFunctor Operation1 \n");
    // bool debug = false;
    ...
    //printf("this is r_sm %d c_sm %d and f_sm %d \n", r_sm, c_sm, f_sm);
    actual_F = F;
  ...
  MGARDX_EXEC void Operation2() {
    //printf( "this is Lpk1Reo3DFunctor Operation2 \n" );
    if (r_gl < nr && c_gl < nc && f_gl < nf_c) {
      //printf(" this is f_sm %d \n", f_sm);
      ...
      //   printf("tc %f\n", tc, td);
      // }
      //printf("this is r_gl %d c_gl %d and f_gl %d \n", r_gl, c_gl, f_gl);
      *dw(r_gl, c_gl, f_gl) =
...
public:
  ...
  GenTask(int queue_idx) {
    ...
    printf("Lpk1 block tbz %d, tby %d, tbx %d \n",tbz, tby, tbx);
    //printf(" this is Lpk1 queue index %d, total_thread_z %d, total_thread_y %d, total_thread_x %d, tbx %d, tby %d, tbz %d, gridx %d , gridy %d, gridz %d \n",queue_idx, total_thread_z, total_thread_y, total_thread_x, tbx, tby, tbz, gridx, gridy, gridz);
...
public:
  ...
  MGARDX_EXEC void Operation1() {
  //printf( "this is Lpk2Reo3DFunctor Operation1 \n" );
    // bool debug = false;
  ...
  MGARDX_EXEC void Operation2() {
    //printf( "this is Lpk2Reo3DFunctor Operation2 \n" );
    if (r_gl < nr && c_gl < nc_c && f_gl < nf_c) {
...
public:
  ...
  GenTask(int queue_idx) {
    ...
    gridy = ceil((float)total_thread_y / tby);
    gridx = ceil((float)total_thread_x / tbx);
    printf("Lpk2 block tbz %d, tby %d, tbx %d \n", tbz, tby, tbx);
    //printf(" this is Lpk2 queue index %d, total_thread_z %d, total_thread_y %d, total_thread_x %d, tbx %d, tby %d, tbz %d, gridx %d , gridy %d, gridz %d \n",queue_idx, total_thread_z, total_thread_y, total_thread_x, tbx, tby, tbz, gridx, gridy, gridz);
    return Task(functor, gridz, gridy, gridx, tbz, tby, tbx, sm_size, queue_idx,
                std::string(Name));
  }
...
public:
  ...
  MGARDX_EXEC void Operation1() {
    //printf( " this is Lpk3Reo3DFunctor Operation1 \n");
    // bool debug = false;
    // if (blockIdx.z == 0 && blockIdx.y == 0 && blockIdx.x == 0 &&
  ...
  MGARDX_EXEC void Operation2() {
    //printf( " this is Lpk3Reo3DFunctor Operation2 \n");
...
public:
  ...
  GenTask(int queue_idx) {
    ...
    gridy = ceil((float)total_thread_y / tby);
    gridx = ceil((float)total_thread_x / tbx);
    printf("Lpk3 block tbz %d, tby %d, tbx %d \n",tbz, tby, tbx);
    //printf(" this is Lpk3 queue index %d, total_thread_z %d, total_thread_y %d, total_thread_x %d, tbx %d, tby %d, tbz %d, gridx %d , gridy %d, gridz %d \n",queue_idx, total_thread_z, total_thread_y, total_thread_x, tbx, tby, tbz, gridx, gridy, gridz);
    return Task(functor, gridz, gridy, gridx, tbz, tby, tbx, sm_size, queue_idx,
                std::string(Name));
  }
