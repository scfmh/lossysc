...
void CalcCorrection3D(Hierarchy<D, T, DeviceType> &hierarchy,
  ...
  //std::cout << " this is lpk1 f c r " << f << " " << c << " " << r << " " << " ff cc rr " << ff << " " << cc << " " << rr << std::endl; 
  ...
  if (D >= 1) {
   ...
   // std::cout << "dw_in2 >=1 details " << dw_in2.shape(0) << " " << dw_in2.shape(1) << " " << dw_in2.shape(2) << std::endl;
   // std::cout << "dw_out >=1 details " << dw_out.shape(0) << " " << dw_out.shape(1) << " " << dw_out.shape(2) << std::endl;
  ...
  //std::cout << " this is lpk2 r, c, ff, cc, " << r << " " << c << " " << ff << " " << cc << std::endl; 
  if (D >= 2) {
    dw_in1 = dw_out;
    ...
    DeviceLauncher<DeviceType>::Execute(
        Lpk2Reo3DKernel<D, T, DeviceType>(r, c, ff, cc, dist_c, ratio_c, dw_in1,
                                          dw_in2, dw_out),
        queue_idx);
    //std::cout << "dw_in2 >=2 details " << dw_in2.shape(0) << " " << dw_in2.shape(1) << " " << dw_in2.shape(2) << std::endl;
    //std::cout << "ddw_out >=2 details " << dw_out.shape(0) << " " << dw_out.shape(1) << " " << dw_out.shape(2) << std::endl;
  ...
  //std::cout << " this is lpk3 r, cc, ff, rr " << r << " " << cc << " " << ff << " " << rr << std::endl;
  if (D == 3) {
    dw_in1 = dw_out;
    ...
    DeviceLauncher<DeviceType>::Execute(
        ...
        queue_idx);
    //std::cout << "dw_in2 ==3 details " << dw_in2.shape(0) << " " << dw_in2.shape(1) << " " << dw_in2.shape(2) << std::endl;
    //std::cout << "ddw_out ==3 details " << dw_out.shape(0) << " " << dw_out.shape(1) << " " << dw_out.shape(2) << std::endl;
  ...
  //std::cout << " this is ipk1 rr, cc, ff " << rr << " " << cc << " " << ff << std::endl;
  if (D >= 1) {
    DeviceLauncher<DeviceType>::Execute(
  ...
  //std::cout << " this is ipk2 rr, cc, ff " << rr << " " << cc << " " << ff << std::endl;
  if (D >= 2) {
    DeviceLauncher<DeviceType>::Execute(
  ...
  //std::cout << " this is ipk3 rr, cc, ff " << rr << " " << cc << " " << ff << std::endl;
  if (D == 3) {
    DeviceLauncher<DeviceType>::Execute(
