...
template <typename TaskType> MGARDX_KERL void SerialKernel(TaskType task) {
  ...
  timer_op.clear(); timer_op1.clear(); timer_op2.clear(); timer_op3.clear();
  timer_alloc.clear();timer_init.clear();timer_dealloc.clear();
}
...
template <typename TaskType> MGARDX_KERL void SerialIterKernel(TaskType task) {
  Timer timer_iop, timer_iop1, timer_iop2, timer_iop3, timer_iop4, timer_iop5, timer_iop6, timer_iop7, timer_iop8, timer_iop9, timer_iop10, timer_iop11,timer_iop12, timer_iop13, timer_iop14, timer_iop15, timer_iop16, timer_iop17, timer_ialloc, timer_iinit, timer_idealloc,timer_reset;
  timer_iop.clear();
  timer_ialloc.clear();timer_iinit.clear();timer_idealloc.clear();
  timer_iop1.clear(); timer_iop2.clear(); timer_iop3.clear();
  timer_iop4.clear(); timer_iop5.clear(); timer_iop6.clear();
  timer_iop7.clear(); timer_iop8.clear(); timer_iop9.clear();
  timer_iop10.clear(); timer_iop11.clear(); timer_iop12.clear();
  timer_iop13.clear(); timer_iop14.clear(); timer_iop15.clear();
  timer_iop16.clear(); timer_iop17.clear(); timer_reset.clear();
 ...
 /* Timer timer_iop, timer_iop1, timer_iop2, timer_iop3, timer_iop4, timer_iop5, timer_iop6, timer_iop7, timer_iop8, timer_iop9, timer_iop10, timer_iop11,timer_iop12, timer_iop13, timer_iop14, timer_iop15, timer_iop16, timer_iop17, timer_ialloc, timer_iinit, timer_idealloc;
  timer_iop.clear();
  timer_ialloc.clear();timer_iinit.clear();timer_idealloc.clear();
  timer_iop1.clear(); timer_iop2.clear(); timer_iop3.clear();
  timer_iop4.clear(); timer_iop5.clear(); timer_iop6.clear();
  ...
  timer_iop10.clear(); timer_iop11.clear(); timer_iop12.clear();
  timer_iop13.clear(); timer_iop14.clear(); timer_iop15.clear();
  timer_iop16.clear(); timer_iop17.clear(); */
  for (SIZE blockz = 0; blockz < task.GetGridDimZ(); blockz++) {
    for (SIZE blocky = 0; blocky < task.GetGridDimY(); blocky++) {
      for (SIZE blockx = 0; blockx < task.GetGridDimX(); blockx++) {
        timer_iinit.start();
        ...
        while (condition1) {
          ...
          timer_iop4.end();
          //timer_iop4.print(task.GetFunctorName() + "_timestemp_Op4");
          timer_iop5.start();
        ...
        timer_iop8.end();
        //timer_iop8.print(task.GetFunctorName() + "_timestemp_Op4");
        timer_iop9.start();
  ...
  timer_idealloc.start();
  DEALLOC_BLOCK_CONDITION;
  timer_idealloc.end();
  timer_iop.print(task.GetFunctorName() + "_Op");
  timer_iop1.print(task.GetFunctorName() + "_Op1");
  timer_iop2.print(task.GetFunctorName() + "_Op2");
  timer_iop3.print(task.GetFunctorName() + "_Op3");
  timer_iop4.print(task.GetFunctorName() + "_Op4");
  timer_iop5.print(task.GetFunctorName() + "_Op5");
  timer_iop6.print(task.GetFunctorName() + "_Op6");
  timer_iop7.print(task.GetFunctorName() + "_Op7");
  timer_iop8.print(task.GetFunctorName() + "_Op8");
  timer_iop9.print(task.GetFunctorName() + "_Op9");
  timer_iop10.print(task.GetFunctorName() + "_Op10");
  timer_iop11.print(task.GetFunctorName() + "_Op11");
  timer_iop12.print(task.GetFunctorName() + "_Op12");
  timer_iop13.print(task.GetFunctorName() + "_Op13");
  timer_iop14.print(task.GetFunctorName() + "_Op14");
  timer_iop15.print(task.GetFunctorName() + "_Op15");
  timer_iop16.print(task.GetFunctorName() + "_Op16");
  timer_iop17.print(task.GetFunctorName() + "_Op17");
  timer_ialloc.print(task.GetFunctorName() + "_Alloc");
  timer_iinit.print(task.GetFunctorName() + "_Init");
  timer_idealloc.print(task.GetFunctorName() + "_Dealloc");
  timer_reset.print(task.GetFunctorName() + "_Reset");
  timer_iop.clear();
  timer_iop1.clear(); timer_iop2.clear(); timer_iop3.clear(); timer_iop4.clear(); timer_iop5.clear(); timer_iop6.clear();
  timer_iop7.clear(); timer_iop8.clear(); timer_iop9.clear(); timer_iop10.clear(); timer_iop11.clear(); timer_iop12.clear();
  timer_iop13.clear(); timer_iop14.clear(); timer_iop15.clear(); timer_iop16.clear(); timer_iop17.clear();  
  timer_ialloc.clear();
  timer_iinit.clear();
  timer_idealloc.clear();
  timer_reset.clear();
...
public:
  ...
  ExecutionReturn Execute(TaskType &task) {
    ...
    //std::cout << " enteracne is here or not " << std::endl;
    /*std::cout << task.GetFunctorName() << ": <"
                << task.GetBlockDimX() << ", " << task.GetBlockDimY() << ", "
                << task.GetBlockDimZ() << "> <" << task.GetGridDimX() << ", "
                << task.GetGridDimY() << ", " << task.GetGridDimZ() << ">\n";*/
    ExecutionReturn ret;
